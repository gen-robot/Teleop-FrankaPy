...
def get_arguments():
    ...
    parser.add_argument("--pos_scale", default=0.015, type=float, help="The scale of xyz action")
    parser.add_argument("--rot_scale", default=0.025, type=float, help="The scale of rotation action")
