...
def plot_save_trajectory(joint_idx, df, t_history, actual_position, goal_position, actual_vel, trajectory_type, output, show_plot):
        # if show_plot:
        #     plt.ion()
        ...
        df.to_csv(os.path.join(data_file_root, data_filename), index=False)
