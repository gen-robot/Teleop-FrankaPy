...
def get_arguments():
    ...
    parser.add_argument("--push_start_frame", type=int, default=10, help="Frame number to start push episode execution from (default: 10).")
    ...
    parser.add_argument("--new_dataset_dir", type=str, default="datasets/yukun/pull_drawer_new_small", help="Directory to save new episodes.")
